...
- **Remote status:** `.github/workflows/release-gates.yml` 将包含独立 Slang 30/30、SystemVerilog 4/4、VHDL semantic equivalence、完整质量检查与隔离 wheel smoke。只有 commit/push 后读取到真实 GitHub Actions 成功结果，才能完成 v0.2 MVP 验收；当前不得声称远端已通过。
